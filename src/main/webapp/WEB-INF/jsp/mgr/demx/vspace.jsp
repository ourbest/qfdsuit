                    ...
                    columns:[
                        [
                            ...
                            {field:'opt',title:'型号创建',width:150,align:'center', rowspan:2,
                                formatter:function(value, rec) {
                                    if (value != null) {
                                        return '<button onClick="viewprj();">项目计划</button> <button onClick="goprj();">技术验证</button>';
                                    }
                                }
                            }
                        ],
...
<div class="mainspace">
    <div id="tt" style="">
        <div title="当前设计型号" style="padding:10px;">
            <div class="srch">
                输入型号代码或名称快速转到相应型号
            </div>
            <div class="srchcxt">
        ...
        <div title="型号高级查询" style="padding:10px;">
            ...
            <div class="srchcxt">
                <div style="height:40px">
                    <input type="text" value="输入型号名称" style="width:400px;height:30px">
                    <button class="prjs">查询型号项目</button>
                </div>
            </div>
            <br/>
        </div>
        <div title="型号设计帮助" style="padding:10px;">
        </div>
    </div>
</div>
