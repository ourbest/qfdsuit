                    ...
                    tools:[
                        {
                            ...
                            text:'构建新型号',
                            handler: function() {
                                location.href = "${pageContext.request.contextPath}/mgr/demx/pcreate";
                            }
                        },
                        {
                            iconCls:'icon-search',
                    ...
                    columns:[
                        [
                            ...
                            {field:'opt',title:'型号创建',width:150,align:'center', rowspan:2,
                                formatter:function(value, rec) {
                                    if (value != null) {
                                        return '<button onClick="viewprj();">型号详情</button> <button onClick="goprj();">型号计划</button>';
                                    }
                                }
                            }
                        ],
...
<div class="mainspace">
    <div id="tt" style="">
        <div title="当前型号项目管理" style="padding:10px;">
            <div class="srch">
                输入型号代码或名称快速转到相应型号
            </div>
            <div class="srchcxt">
                <div style="height:40px">
                    ...
                    <button class="prjs" onclick="goprj()">型号计划</button>
                </div>
            </div>
            <br/>
        ...
        <div title="型号项目管理高级查询" style="padding:10px;">
            <div class="srch">
                输入型号代码或名称快速转到相应型号
            </div>
            <div class="srchcxt">
        ...
        <div title="构建型号帮助" style="padding:10px;">
        </div>
    </div>
</div>
