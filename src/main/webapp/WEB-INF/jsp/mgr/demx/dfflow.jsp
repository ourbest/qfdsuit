...
<div class="mainspace">
    <div id="tt" style="">
        <div title="FMC分析流程模型定义" style="padding:10px;">
        ...
        <div title="FMC分析流程备注信息" style="padding:10px;">
    ...
    <div id="ptt">
        <div title="FMC分析流程节点" style="padding:10px;text-align: center">
            <div class="tabui">
                <ul>
                    <li>
                        <span class="a" style="padding:4px 0;background:#EEE">序号</span>
                        <span class="n" style="padding:4px 0;background:#EEE">分析类型</span>
