...
<script>
                    ...
                    columns:[
                        [
                            ...
                            {field:'opt',title:'型号创建',width:150,align:'center', rowspan:2,
                                formatter:function(value, rec) {
                                    if (value != null) {
                                        return '<button onClick="viewprj();">型号详情</button> <button onClick="goprj();">需求分析</button>';
                                    }
                                }
                            }
                        ],
    ...
    function goprj() {
        location.href = "${pageContext.request.contextPath}/mgr/demx/reqdef";
    }
...
<div class="mainspace">
    <div id="tt" style="">
        <div title="当前型号需求分析" style="padding:10px;">
            <div class="srch">
                输入型号代码或名称快速转到相应型号
            </div>
            <div class="srchcxt">
                <div style="height:40px">
                    ...
                    <button class="prjs" onclick="create()">型号需求分析</button>
                </div>
            </div>
            <br/>
        ...
        <div title="型号需求分析帮助" style="padding:10px;">
        </div>
    </div>
</div>
