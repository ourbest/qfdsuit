        ...
        $('#acs').datagrid({
                    ...
                    columns:[
                        [
                            ...
                            {field:'name',title:'设计活动',width:140,
...
<div class="easyui-accordion" fit="true" border="false">
    <div title="设计过程模板" style="overflow:auto;">
        <div style="padding:4px;background:#EFEFEF;height:24px;line-height:24px;border-bottom:#ccc 1px solid"><img
                src="${pageContext.request.contextPath}/static/images/icon/search32.png" style="width:16px;height:16px;border:0"><input type="text"
            <button>搜索</button>
        </div>
