...
<div class="mainspace">
    <div id="tt" style="">
        <div title="型号设计" style="padding:10px;">
            <table cellpadding="4" cellspacing="0" width="100%">
                <tr>
                    <td>
                        <a class="button" href="#" onclick="req()"><span>需求分析</span></a>
                        <a class="button" href="#" onclick="ds()"><span>方案设计</span></a>
                        <a class="button" href="#" onclick="dv()"><span>指标验证</span></a>
                        <a class="button" href="#" onclick="mdo()"><span>方案优化</span></a>
                    </td>
                </tr>
            </table>
            <br/>
