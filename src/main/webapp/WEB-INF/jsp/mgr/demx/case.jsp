...
<script>
                    ...
                    columns:[
                        [
                            ...
                            {field:'opt',title:'型号创建',width:150,align:'center', rowspan:2,
                                formatter:function(value, rec) {
                                    if (value != null) {
                                        return '<button onClick="viewprj();">项目计划</button> <button onClick="goprj();">案例详情</button>';
                                    }
                                }
                            }
                        ],
    ...
    function goprj() {
        location.href = "${pageContext.request.contextPath}/mgr/demx/pcase";
    }
...
<div class="mainspace">
    <div id="tt" style="">
        <div title="当前型号案例" style="padding:10px;">
            <div class="srch">
                输入型号代码或名称快速转到相应型号
            </div>
            <div class="srchcxt">
