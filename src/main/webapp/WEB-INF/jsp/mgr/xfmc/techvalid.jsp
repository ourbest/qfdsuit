        ...
        $('#kresult').datagrid({
                    ...
                    columns:[
                        [
                            ...
                            {field:'opts',title:'验证结果',width:200,rowspan:2},
...
<div class="mainspace">
    <div id="tt">
        <div title="型号总体系统指标" style="padding:10px;">
            ...
            <div id="sst">
                <div title="方案设计分解" style="padding:10px;">
                    <div class="mainspace">
                        ...
                        <div style="width:950px">
                            <div class="blk">
                                <ul>
                                    <li><a href="${pageContext.request.contextPath}/mgr/xfmc/qdtv">气动系统</a></li>
                                    <li><a href="${pageContext.request.contextPath}/mgr/xfmc/tjtv">推进系统</a></li>
                                    <li><a href="#">重量</a></li>
                                    <li><a href="#">飞行性能</a></li>
                ...
                <div title="方案验证过程" style="padding:10px;text-align:center">
