        ...
        $('#sresult').datagrid({
                    ...
                    columns:[
                        ...
                        [
                            ...
                            {field:'sopt',title:'是否优化',width:80,rowspan:2},
                            {field:'sdown',title:'下限值',width:80,rowspan:2},
                            {field:'sup',title:'上限值',width:80,rowspan:2}
                        ]
                    ],
                    pagination:true,
                    rownumbers:true
...
<div class="easyui-tabs" fit="true" border="false">
    <div title="CAD模型验证" style="overflow:auto;">
        <div id="mv" class="mainspace">
            <table cellpadding="4" cellspacing="0" width="950">
                <tr>
                    <td>
                        <a class="button" href="#" onclick="updatew()"><span>新创建CAD</span></a>
                        <a class="button" href="#" onclick="showCAD()"><span>CAD模型查看</span></a>
...
<div id="win" class="easyui-window" closed="true" modal="true" title="CAD模型查看" style="width:640px;height:480px;">
...
<div id="updatew" class="easyui-window" closed="true" modal="true" title="CAE模型创建" style="width:600px;height:280px;">
    <div class="easyui-layout" fit="true">
        <div region="center" border="false" style="padding:10px;background:#fff;border:1px solid #ccc;">
            <table cellpadding="4" cellspacing="0" class="prjwin">
                <tr>
                    <td width="80"></td>
                    <td width="140">零件名称：</td>
                ...
                <tr>
                    <td width="80"></td>
                    <td width="140">模型文件：</td>
                    <td><input type="file" value="xxx-001" style="width:400px"></td>
                </tr>
            </table>
        </div>
        <div region="south" border="false" style="text-align:right;height:30px;line-height:30px;">
