...
<div class="easyui-tabs" fit="true" border="false">
    <div title="FAV手册快速验证" style="overflow:auto;">
        <div id="mv" class="mainspace">
            <table cellpadding="4" cellspacing="0" width="950">
                <tr>
                    <td>
                        <a class="button" href="#" onclick="updatew()"><span>FAV选择</span></a>
                        <a class="button" href="#" onclick="showFAV()"><span>FAV校核操作</span></a>
                    </td>
                </tr>
            </table>
        </div>
...
<div id="win" class="easyui-window" closed="true" modal="true" title="FAV模型校核" style="width:730px;height:460px;">
    <div class="easyui-layout" fit="true">
        <div region="center" border="false" style="padding:10px;background:#fff;border:1px solid #ccc;">
            <img src="${pageContext.request.contextPath}/static/images/favr.png">
        </div>
...
<div id="updatew" class="easyui-window" closed="true" modal="true" title="FAV模型选择" style="width:730px;height:460px;">
    <div class="easyui-layout" fit="true">
        <div region="center" border="false" style="padding:10px;background:#fff;border:1px solid #ccc;">
            <img src="${pageContext.request.contextPath}/static/images/favs.png">
        </div>
        <div region="south" border="false" style="text-align:right;height:30px;line-height:30px;">
            <a class="easyui-linkbutton" iconCls="icon-ok" href="javascript:void(0)" onclick="viwclose()">确定</a>
            <a class="easyui-linkbutton" iconCls="icon-cancel" href="javascript:void(0)" onclick="viwclose()">取消</a>
