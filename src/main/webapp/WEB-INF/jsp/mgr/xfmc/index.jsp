                    ...
                    columns:[
                        [
                            ...
                            {field:'opt',title:'型号创建',width:150,align:'center', rowspan:2,
                                formatter:function(value, rec) {
                                    if (value != null) {
                                        return '<button onClick="viewprj();">型号详情</button> <button onClick="goprj();">类似创建</button>';
                                    }
                                }
                            }
                        ],
...
<div class="mainspace">
    <div id="tt" style="">
        <div title="当前管理型号" style="padding:10px;">
            <div class="srch">
                输入型号代码或名称快速转到相应型号
            </div>
            <div class="srchcxt">
                <div style="height:40px">
                    ...
                    <button class="prjs" onclick="create()">构建新型号</button>
                </div>
            </div>
            <br/>
