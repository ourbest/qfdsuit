<script>
    $(function() {
        $("#tooltips").qtip({
                    content: {
                        url: '${pageContext.request.contextPath}/static/tips/desshelp.html'
                    },
                    style: {
                        tip: {
                            corner: 'topLeft'
...
<div class="easyui-tabs" fit="true" border="false">
    <div title="多学科仿真验证" style="overflow:auto;">
        <div id="mv" class="mainspace">
            <table cellpadding="4" cellspacing="0" width="950">
                <tr>
                    <td>
                        <a class="button" href="#" onclick="showAn()"><span>选择多学科仿真分析工具</span></a>
                        <a class="button" href="#" onclick="showSys()"><span>多学科仿真结果查看</span></a>
                    </td>
                </tr>
            </table>
        </div>
...
<div id="tools" class="easyui-window" closed="true" modal="true" title="选择分析工具" style="width:730px;height:380px;">
    <div class="easyui-layout" fit="true">
        <div region="center" border="false" style="padding:10px;background:#fff;border:1px solid #ccc;">
            <div class="soft">
                <ul>
                    <li><span><img src="${pageContext.request.contextPath}/static/images/msc.png"></span><span>MSC Software</span></li>
                    <li><span><img src="${pageContext.request.contextPath}/static/images/hypermesh.png"></span><span>HyperMesh</span></li>
                    <li><span><img src="${pageContext.request.contextPath}/static/images/ansyssoft.png"></span><span>Ansys</span></li>
                    <li><span><img src="${pageContext.request.contextPath}/static/images/abaqus.png"></span><span>Abaqus</span></li>
                    <li><span><img src="${pageContext.request.contextPath}/static/images/fluent.png"></span><span>Fluent</span></li>
                    <li><span><img src="${pageContext.request.contextPath}/static/images/powerflow.png"></span><span>PowerFlow</span></li>
                </ul>
            </div>
        </div>
