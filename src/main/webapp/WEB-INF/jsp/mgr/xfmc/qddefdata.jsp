<script>
    $(function() {
        $('#qdSchemeData').treegrid({
                    title:'气动外形方案',
                    nowrap:false,
                    rownumbers:true,
                    animate:true,
                    colapsible:true,
                    url:'${pageContext.request.contextPath}/ajax/xfmc/qddefdata_data',
                    idField:'code',
                    treeField:'code',
                    frozenColumns:[
                        [
                    ...
                    columns:[
                        [
                            ...
                            {field:'sureScheme',title:'方案验证',width:200, rowspan:2,
                                formatter:function(value) {
                    ...
                    onBeforeLoad:function(row, param) {
                        if (row) {
                            ...
                            $(this).treegrid('options').url = '${pageContext.request.contextPath}/ajax/xfmc/qddefdata_data';
                        }
                    },
    ...
    function next() {
        location.href = "${pageContext.request.contextPath}/mgr/xfmc/des";
    }
    function tv() {
        location.href = "${pageContext.request.contextPath}/mgr/xfmc/qdtv";
    }
