...
import com.demx.exception.util.ExceptionUtils;
...
public class NestableDelegate
     ...
     * @since 2.0
     */
    private static final boolean TRIMSTACK = true;
     ...
     * 'TRIMSTACK' parameters. The TOPDOWN and TRIMSTACK
     ...
     * @since 2.0
     */
    protected void TRIMSTACK(List stacks) {
